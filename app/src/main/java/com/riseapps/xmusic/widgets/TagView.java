...
public class TagView extends RelativeLayout {
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        this.lineMargin = (int) typeArray.getDimension(R.styleable.TagView_lineMargin, DipToPx.dipToPx(this.getContext(), Constants.DEFAULT_LINE_MARGIN));
        this.tagMargin = (int) typeArray.getDimension(R.styleable.TagView_tagMargin, DipToPx.dipToPx(this.getContext(), Constants.DEFAULT_TAG_MARGIN));
        this.textPaddingLeft = (int) typeArray.getDimension(R.styleable.TagView_textPaddingLeft, DipToPx.dipToPx(this.getContext(), Constants.DEFAULT_TAG_TEXT_PADDING_LEFT));
        this.textPaddingRight = (int) typeArray.getDimension(R.styleable.TagView_textPaddingRight, DipToPx.dipToPx(this.getContext(), Constants.DEFAULT_TAG_TEXT_PADDING_RIGHT));
        this.textPaddingTop = (int) typeArray.getDimension(R.styleable.TagView_textPaddingTop, DipToPx.dipToPx(this.getContext(), Constants.DEFAULT_TAG_TEXT_PADDING_TOP));
        this.textPaddingBottom = (int) typeArray.getDimension(R.styleable.TagView_textPaddingBottom, DipToPx.dipToPx(this.getContext(), Constants.DEFAULT_TAG_TEXT_PADDING_BOTTOM));
        typeArray.recycle();
    }
    ...
    private void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            // inflate tag layout
            final View tagLayout = mInflater.inflate(R.layout.tagview_item, null);
            ...
            tagLayout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mClickListener != null) {
                        mClickListener.onTagClick(tagLayout, tagView, tag, position);
                    }
                }
            });
            ...
            tagLayout.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mTagLongClickListener != null) {
                        mTagLongClickListener.onTagLongClick(tagLayout, tagView, tag, position);
                    }
                    return true;
                }
            });
            ...
            if (mWidth <= total + tagWidth + DipToPx.dipToPx(this.getContext(), Constants.LAYOUT_WIDTH_OFFSET)) {
    ...
    private Drawable getSelector(Tag tag) {
        ...
        if (tag.layoutBorderSize > 0) {
            gdNormal.setStroke(DipToPx.dipToPx(getContext(), tag.layoutBorderSize), tag.layoutBorderColor);
        }
        ...
        GradientDrawable gdPressLong = new GradientDrawable();
        gdPressLong.setColor(tag.layoutColorLongPress);
        gdPressLong.setCornerRadius(tag.radius);
        states.addState(new int[]{android.R.attr.state_long_pressable}, gdPressLong);
    ...
    public void setLineMargin(float lineMargin) {
        this.lineMargin = DipToPx.dipToPx(getContext(), lineMargin);
    }
    ...
    public void setTagMargin(float tagMargin) {
        this.tagMargin = DipToPx.dipToPx(getContext(), tagMargin);
    }
    ...
    public void setTextPaddingLeft(float textPaddingLeft) {
        this.textPaddingLeft = DipToPx.dipToPx(getContext(), textPaddingLeft);
    }
    ...
    public void setTextPaddingRight(float textPaddingRight) {
        this.textPaddingRight = DipToPx.dipToPx(getContext(), textPaddingRight);
    }
    ...
    public void setTextPaddingTop(float textPaddingTop) {
        this.textPaddingTop = DipToPx.dipToPx(getContext(), textPaddingTop);
    }
    ...
    public void settextPaddingBottom(float textPaddingBottom) {
        this.textPaddingBottom = DipToPx.dipToPx(getContext(), textPaddingBottom);
    }
    ...
    public interface OnTagClickListener {
        void onTagClick(View view, TextView tagView, Tag tag, int position);
    }

    public interface OnTagLongClickListener {
        void onTagLongClick(View view, TextView tagview, Tag tag, int position);
    }
}
